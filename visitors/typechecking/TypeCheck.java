...
public class TypeCheck implements Visitor<Type> {
	...
	//New FOR stmt, ident and exp must be Integers
	@Override
	...
	@Override
	public Type visitSeasonLiteral(Season season) {
		return SEASON;
	}
	
	//SeasonOf only accepts Integers and only returns Seasons
	@Override
	...
	//NumOf only accepts Seasons and always returns Integers
	@Override
